...
<td><a href="delete.php?email=<?php echo $row['Email'];?>&role=<?php echo 'student';?>"><input type="button" value="delete" style="border:0px;background-color:#2c6ed5;height:30px;width:70px;"></a></td>
</tr>		
